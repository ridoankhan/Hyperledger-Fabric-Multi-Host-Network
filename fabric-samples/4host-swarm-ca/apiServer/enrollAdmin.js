...
const filePath = path.join(process.cwd(), 'connection-profile.json');
let fileContents = fs.readFileSync(filePath, 'utf8');
let connectionFile = JSON.parse(fileContents);
...
async function main() {
    try {
        ...
        const caInfo = connectionFile.certificateAuthorities['rca-org1'];
